...
variable "enable_calico" {
  description = "Enable Calico server add-on"
  type        = bool
  default     = false
}

variable "calico" {
  description = "Calico CNI add-on configurations"
  type        = any
  default     = {}
}
################################################################################
...
variable "enable_opentelemetry-collector" {
  description = "Enable Opentelemetry Collector"
  type        = bool
  default     = false
}

variable "opentelemetry-collector" {
  description = "Opentelemetry Collector add-on configurations"
  type        = any
  default     = {}
}
